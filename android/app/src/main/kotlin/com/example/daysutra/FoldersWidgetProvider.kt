...
class FoldersWidgetProvider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.folders_widget_layout).apply {
                ...
                val imagePath = widgetData.getString("folders_widget_image", null)
                if (imagePath != null) {
                    ...
                    if (bitmap != null) {
                        ...
                        setTextViewText(R.id.fallback_title, "Folders")
