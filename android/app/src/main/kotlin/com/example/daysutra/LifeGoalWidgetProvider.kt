...
class LifeGoalWidgetProvider : HomeWidgetProvider() {
    override fun onUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            val views = RemoteViews(context.packageName, R.layout.life_goal_widget_layout).apply {
                ...
                val imagePath = widgetData.getString("life_goal_widget_image", null)
                if (imagePath != null) {
                    ...
                    if (bitmap != null) {
                        ...
                        setTextViewText(R.id.fallback_title, "Life Goal")
